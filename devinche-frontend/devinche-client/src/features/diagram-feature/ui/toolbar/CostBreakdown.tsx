  ...
  return (
    <div className="flex items-center">
      <button
        ...
        className="px-3 py-1.5 rounded text-sm font-medium flex items-center gap-1.5 transition-colors text-[var(--editor-text)] hover:bg-[var(--editor-surface-hover)] cursor-pointer"
