// src/features/diagram-feature/ui/palette/paletteData.tsx
import React from 'react';
import { Pointer, ArrowUpIcon } from 'lucide-react';
...
export const AiNodes: PaletteItem[] = [
    {
        id: 'dataset-node',
        type: 'node',
        label: 'Dataset',
        ...
        icon: (
            ...
            >
                ...
                />
                {/* Black Dot in Center */}
                <circle cx="38.5" cy="44" r="12" fill="#000000" />
            </svg>
        ),
    },
    {
        ...
        icon: (
            <svg width="18" height="18" viewBox="0 0 87 88" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="43.6147" cy="43.7823" r="41.6676" stroke="currentColor" strokeWidth="2.87363" />
                <circle cx="43.6147" cy="43.7823" r="12" fill="#000000" stroke="none" />
            </svg>
        ),
    },
    {
...
export const Nodes: PaletteItem[] = [
    {
        id: 'application-node',
        type: 'node',
        label: 'Application',
    ...
    },
    {
        ...
        icon: (
            <svg width="18" height="18" viewBox="0 0 87 100" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
...
export const Edges: PaletteItem[] = [
    // {
    //     id: 'step-edge',
    //     type: 'edge',
    //     label: 'Step Edge',
